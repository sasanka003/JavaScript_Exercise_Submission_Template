<div><h1>Exercise Submission Webpage</h1>[![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)]([LICENSE](https://github.com/sasanka003/JavaScript_Exercise_Submission_Template/blob/main/LICENSE))</div>
